...
var all = {
  ...
  breweryDBKey: 'bdb-key',
  googleServerAPIKey: 'google-key',
  facebook: {
  ...
  twitter: {
    clientID:     process.env.TWITTER_ID || 'twitter-id',
    clientSecret: process.env.TWITTER_SECRET || 'twitter-secret',
